...
def main(argv):
    ...
    addA_success_reader = read_csv("./" + ql_path + "/addA_success.csv")
    ...
    rmA_success_reader = read_csv("./" + ql_path + "/rmA_success.csv")
    ...
    chB_success_reader = read_csv("./" + ql_path + "/chB_success.csv")
    ...
    addA_usage_reader = read_csv("./" + ql_path + "/addA_usage.csv")
    ...
    rmA_usage_reader = read_csv("./" + ql_path + "/rmA_usage.csv")
    ...
    # chB usage evolution over steps
    chB_usage_reader = read_csv("./" + ql_path + "/chB_usage.csv")
    ...
    addA_reader = read_csv("./" + ql_path + "/addA_success_rates.csv")
    ...
    rmA_reader = read_csv("./" + ql_path + "/rmA_success_rates.csv")
    ...
    chB_reader = read_csv("./" + ql_path + "/chB_success_rates.csv")
